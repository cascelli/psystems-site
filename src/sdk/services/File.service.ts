...
class FileService extends Service {
  static getSignedUrl(fileInfo: File.UploadRequestInput) {
    // Retorna um FileUploadReqest
    return this.Http.post<File.UploadRequest>(
      '/upload-requests',
      fileInfo
    )
      .then(this.getData)
  ...
  // funcopes para trabalhar file Upload no Google Cloud Platform (GCP)
  ...
  static async upload(file: File) {
    ...
    await FileService.uploadFileToSignedUrl(
      singedUrl,
      file
    );
