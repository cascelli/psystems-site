// export default function EmpVirtual() {
//   return <div>ToDo: EmpVirtual - Feature</div>;
// }
  ...
  return (
    <>
      ...
      <Paragraph>
        ...
        atribuir um controle de restrição e proteger os mesmos contra apagamento
        acidental, contaminação por vírus, criando uma infraestrutura racional
        de sua empresa e torná-la acessível a partir de qualquer local para um
        ou mais funcionários ?
      </Paragraph>
      <ul>
        <li>
          Você saiu de férias e precisou acessar um documento a partir do hotel
        ...
        <li>
          ...
          aplicativo da empresa e entregá-lo em tempo real ao seu cliente antes
          de encerrar uma reunião ou um serviço estando fora das dependências
          fisicas da mesma ?
        </li>
        <li>
          Você acordou indisposto e não conseguiu ir trabalhar e precisa
          concluir um trabalho para disparar um contrato com cliente que aguarda
          confirmação urgente e não pode comparecer de imediato ao seu local
          para concluir o processo ?
        </li>
        <li>
          Você foi embora do seu serviço no final de semana, desligou sua
          estação de trabalho e precisou de um documento armazenado no mesmo com
          urgência ?
        </li>
        <li>
          Você quer manter alguns documentos de seu desktop do trabalho
          sincronizados com o seu computador de casa, de modo a poder transitar
          de um local para o outro e ter acesso as últimas modificações ?
        </li>
      </ul>
      <Paragraph>
      ...
      <Paragraph>
        Configuramos a "virtualização" de acesso a infraestrutura empresarial na
        internet.
      </Paragraph>
      <Paragraph>
      ...
      <ul>
        <li>
          Configuração de infraestrutura de rede local, servidores de arquivos,
          firewalls, gateways, roteadores, rotinas de cópias de segurança
          automatizadas, redundâncias e alta disponibilidade.
        </li>
        ...
        <li>
          Sincronização de documentos de usuários entre equipamentos, semelhante
          a OneDrive, GoogleDrive, DropBox, etc. através de clientes de
          sincronização.
        </li>
      </ul>
      <Paragraph>
        ...
        experiência e confiança ao propor opções plausíveis aos nossos clientes
        de modo a atendê-los plenamente.
      </Paragraph>
      <Paragraph>
